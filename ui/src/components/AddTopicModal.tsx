    ...
    <ModalDialog title="Add Topic" onClose={onClose} style={{ minWidth: 400, maxWidth: 520 }}>
      <form onSubmit={(e) => { e.preventDefault(); void form.handleSubmit() }}>
        <form.Field name="topic">
          {(field) => (
            <div style={fieldWrap}>
              <label htmlFor={topicFieldId} style={labelStyle}>Topic *</label>
              <input id={topicFieldId} className="jx-input-box" value={field.state.value} onChange={e => field.handleChange(e.target.value)} required />
            </div>
          )}
        </form.Field>
